...
- Understand propositional logic and logical operators
- Build truth tables and apply inference rules
- Work with First-Order Logic (FOL) syntax and semantics
...
- Key inference rules: Modus Ponens, Modus Tollens, Disjunctive Syllogism
...
- **Examples:** See `examples/` folder
  - `02_Knowledge_Representation.ipynb` - Knowledge representation concepts
- **Exercises:** See `exercises/` folder
  - `exercise_02_knowledge_representation.ipynb` - Practice problems
- **Solutions:** See `solutions/` folder
- **Quizzes:** See `../QUIZZES/Quiz_02_Knowledge_Representation.md`
